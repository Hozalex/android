...
public class IntentHelper {
    ...
    public static final String EXTRA_CHECKBOX_PRESSURE = "checkBoxPressure";
    public static final String EXTRA_CHECKBOX_HUMIDITY = "checkBoxHumidity";
    public static final String EXTRA_CHECKBOX_WIND = "checkBoxWind";
