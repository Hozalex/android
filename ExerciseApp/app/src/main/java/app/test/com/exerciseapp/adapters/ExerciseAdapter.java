package app.test.com.exerciseapp.adapters;
...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.ExerciseViewHolder> {
    ...
    @NonNull
    @Override
    public ExerciseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, final int viewType) {
        final ExerciseViewHolder viewHolder=new ExerciseViewHolder(LayoutInflater.from(parent.getContext())
    ...
    {
        void onExerciseClick(int exerciseNum);
    }
}
